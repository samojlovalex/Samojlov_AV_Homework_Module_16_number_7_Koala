...
class EntryFragment : Fragment() {
    ...
    private fun init() {
        emailET = binding.includeFormEntry.emailRegistrationET
        passwordET = binding.includeFormEntry.passwordRegistrationET
        confirmPasswordET = binding.includeFormEntry.confirmPasswordRegistrationET
        entryBT = binding.includeFormEntry.inputButtonBT
        textViewInputFormTV = binding.includeFormEntry.textViewInputFormTV
    ...
    private fun login() {
        ...
        auth.signInWithEmailAndPassword(email,pass).addOnCompleteListener(requireActivity()){
            if (it.isSuccessful){
                ...
                textViewInputFormTV.layoutParams = LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT)
            }
        }
    }
    ...
    private fun transition() {
        view?.findNavController()?.navigate(R.id.action_entryFragment_to_letterFragment)
    }
