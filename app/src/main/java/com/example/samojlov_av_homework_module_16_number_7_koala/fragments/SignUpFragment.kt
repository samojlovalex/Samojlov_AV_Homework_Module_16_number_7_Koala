...
import com.example.samojlov_av_homework_module_16_number_7_koala.databinding.FragmentSignUpBinding
...
class SignUpFragment : Fragment() {
    ...
    private fun init() {
        emailET = binding.includeFormRegistration.emailRegistrationET
        passwordET = binding.includeFormRegistration.passwordRegistrationET
        confirmPasswordET = binding.includeFormRegistration.confirmPasswordRegistrationET
        signUpBT = binding.includeFormRegistration.inputButtonBT
        textViewInputFormTV = binding.includeFormRegistration.textViewInputFormTV
